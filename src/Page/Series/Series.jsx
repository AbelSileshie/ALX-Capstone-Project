...
import { SearchSeries } from "../../utils/APIPath";
...
const Series = () => {
  ...
  const fetchMovies = async (query) => {
    ...
    try {
      const Search = SearchSeries(query);
              ...
              <section className="w-auto h-72 relative">
                <div className="flex flex-col items-center justify-center mb-4">
                  <img
                    ...
                    alt="Movie Banner"
                    className="w-full h-72 rounded-lg object-cover object-top"
                  />
                        ...
                        >
                          <Card.Body className="relative overflow-hidden p-0 h-[13rem] shadow-lg">
                            ...
                            <img
                              ...
                              alt={movie.name}
                              className="w-[10rem] h-full object-cover object-top rounded-md mx-auto cursor-pointer"
